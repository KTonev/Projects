...
public class Main {
    public static void main(String[] args) throws InterruptedException, IOException {
        ...
        printHouse.setSalaryForWorker(1000);
        printHouse.setIncomeForBonus(100);
        ...
        printHouse.addWorker(worker1);
        printHouse.addWorker(worker2);



        if (printHouse.getIncomeForBonus() <= printHouse.getIncome()) {
            printHouse.setBonus(10);
        }
