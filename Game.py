...
def reset_level(level):
    ...
    # shield image for showing the score
    score_shield = Shield(tile_size // 2, tile_size // 2)
    shield_group.add(score_shield)
    return world
...
class Player():
    ...
    def update(self, game_over):
        ...
        if game_over == 0:
            ...
            # enemies
            if pygame.sprite.spritecollide(self, minion_group, False):
                game_over = -1
    ...
    def reset(self, x, y):
        ...
        self.index = 0
        self.counter = 0
        img_right = pygame.image.load(f'img/guy.png')
        ...
        for row in data:
            ...
            for tile in row:
                ...
                if tile == 2:
                    ...
                    self.tile_list.append(tile)
                if tile == 3:
                    minion = Enemy(col_count * tile_size, row_count * tile_size + 15)
                ...
                if tile == 6:
                    ...
                    lava_group.add(lava)
                if tile == 7:
                    shield = Shield(col_count * tile_size + (tile_size // 2), row_count * tile_size + (tile_size // 2))
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.image = pygame.image.load('img/minion.png')
        self.rect = self.image.get_rect()
        self.rect.x = x
        self.rect.y = y
...
class Shield(pygame.sprite.Sprite):
    def __init__(self, x, y):
        pygame.sprite.Sprite.__init__(self)
        img = pygame.image.load('img/shield.png')
...
while run:
    ...
    if main_menu == True:
        ...
        if game_over == 0:
            ...
            # update score if a shield has been collected
